...
from openapi_client.models.v4_alphabets_one_response_data import V4AlphabetsOneResponseData  # noqa: E501
from openapi_client.rest import ApiException

class TestV4AlphabetsOneResponseData(unittest.TestCase):
    """V4AlphabetsOneResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V4AlphabetsOneResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.v4_alphabets_one_response_data.V4AlphabetsOneResponseData()  # noqa: E501
        if include_optional :
            return V4AlphabetsOneResponseData(
                name = None, 
                script = None, 
                family = None, 
                type = None, 
    ...
    def testV4AlphabetsOneResponseData(self):
        """Test V4AlphabetsOneResponseData"""
