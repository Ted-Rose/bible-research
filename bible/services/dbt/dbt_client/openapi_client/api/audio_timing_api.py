...
class AudioTimingApi(object):
    ...
    def v4_timestamps(self, v, **kwargs):  # noqa: E501
        """Returns Bible Filesets which have audio timestamps  # noqa: E501

        This call returns a list of fileset that have timestamp metadata associated with them. This data could be used to search audio bibles for a specific term, make karaoke verse & audio readings, or to jump to a specific location in an audio file.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v4_timestamps(v, async_req=True)
        >>> result = thread.get()
        ...
        return self.v4_timestamps_with_http_info(v, **kwargs)  # noqa: E501

    def v4_timestamps_with_http_info(self, v, **kwargs):  # noqa: E501
        """Returns Bible Filesets which have audio timestamps  # noqa: E501

        This call returns a list of fileset that have timestamp metadata associated with them. This data could be used to search audio bibles for a specific term, make karaoke verse & audio readings, or to jump to a specific location in an audio file.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v4_timestamps_with_http_info(v, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('v' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `v` when calling `v4_timestamps`")  # noqa: E501
